...
const MethodEdit = ({ userData, settings }) => {
  ...
  const handleUpdate = (e) => {
    ...
    methodUpdate(id, params, setActionLoader);
  };
...
export default withAuthAdmin(MethodEdit);
